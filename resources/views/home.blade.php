...
$SalesSum=DB::table('sales')->sum('qnty');
$LikeSum=DB::table('like')->sum('LikeQty');
$TrafficSum=DB::table('Traffic')->sum('TrafficQty');
$Members=DB::table('users')->count();

$sale1 = DB::table('sales')->where('type',1)->pluck('qnty');
$sale2 = DB::table('sales')->where('type',2)->pluck('qnty');
$sale3 = DB::table('sales')->where('type',3)->pluck('qnty');
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{asset('adminlte/dist/img/Logo-PM-SCADA.png')}}" alt="Logo-PM-SCADA" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('adminlte/dist/img/Logo-PM-SCADA.png')}}" alt="Logo-PM-SCADA Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">PM SCADA</span>
    </a>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?=$LikeSum?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?=$SalesSum?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
